...
* **Student Management System:** A robust backend built with **Java Spring Boot** and **PostgreSQL**, focusing on clean architecture and efficient data handling.
* **Mobile App Ecosystem:** Developing cross-platform mobile solutions using **React Native**, integrated with **Sentry** for real-time monitoring and crash reporting.
* **Story Management Platform:** A full-stack web application using **PHP** and **Java** to manage and display digital content effectively.
